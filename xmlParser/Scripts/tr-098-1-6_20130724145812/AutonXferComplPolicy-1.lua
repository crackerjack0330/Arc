...
paraPath = "InternetGatewayDevice.ManagementServer.AutonomousTransferCompletePolicy.Enable"
...
paraPath = "InternetGatewayDevice.ManagementServer.AutonomousTransferCompletePolicy.TransferTypeFilter"
ret = acs.GetParameterValues(paraPath)
acs.execute()
if ret == "9005" then
	log:write("[" .. os.date() .. "]" .. "[GetParameterValues][FAIL]" .. "[" .. paraPath .. "][" .. ret .. "]\n")
...
paraPath = "InternetGatewayDevice.ManagementServer.AutonomousTransferCompletePolicy.FileTypeFilter"
ret = acs.GetParameterValues(paraPath)
acs.execute()
if ret == "9005" then
	log:write("[" .. os.date() .. "]" .. "[GetParameterValues][FAIL]" .. "[" .. paraPath .. "][" .. ret .. "]\n")
