...
paraPath = "InternetGatewayDevice.BulkData.Profile."
...
paraPath = "InternetGatewayDevice.BulkData.Profile.1.StreamingHost"
...
paraPath = "InternetGatewayDevice.BulkData.Profile.1.StreamingPort"
ret = acs.GetParameterValues(paraPath)
acs.execute()
if ret == "9005" then
	log:write("[" .. os.date() .. "]" .. "[GetParameterValues][FAIL]" .. "[" .. paraPath .. "][" .. ret .. "]\n")
...
paraPath = "InternetGatewayDevice.BulkData.Profile.1.StreamingSessionID"
ret = acs.GetParameterValues(paraPath)
acs.execute()
if ret == "9005" then
	log:write("[" .. os.date() .. "]" .. "[GetParameterValues][FAIL]" .. "[" .. paraPath .. "][" .. ret .. "]\n")
